...
console.log('%c║   Welcome to Gaurang Goel\'s Portfolio!               ║', 'color: #00d4ff; font-weight: bold;');
console.log('%c║   Data Engineer | Cloud Architect | AI Enthusiast     ║', 'color: #00d4ff; font-weight: bold;');
console.log('%c║                                                       ║', 'color: #00d4ff; font-weight: bold;');
console.log('%c║   Let\'s build something amazing together!            ║', 'color: #ff006e; font-weight: bold;');
console.log('%c╚═══════════════════════════════════════════════════════╝', 'color: #00d4ff; font-weight: bold;');

console.log('%cTech Stack: Azure | Databricks | Python | Data Governance', 'color: #8338ec; font-weight: bold;');
console.log('%cOpen to: Opportunities | Collaborations | Knowledge Sharing', 'color: #06d6a0; font-weight: bold;');
